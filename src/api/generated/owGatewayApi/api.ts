...
export const BlacklistApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    createBlackListDevice: async (
      ...
      const localVarPath = `/blacklist/{serialNumber}`.replace(
        `{${'serialNumber'}}`,
...
export const BlacklistApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createBlackListDevice(
      serialNumber: string,
      blackDeviceInfo?: BlackDeviceInfo,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createBlackListDevice(
        serialNumber,
        blackDeviceInfo,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async getBlacklistDevice(
      serialNumber: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BlackDeviceInfo>> {
     ...
     * @throws {RequiredError}
     */
    async getBlacklistDeviceList(
      offset?: number,
      limit?: number,
      filter?: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BlackDeviceList>> {
...
export const BlacklistApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createBlackListDevice(
      ...
      return localVarFp
        .createBlackListDevice(serialNumber, blackDeviceInfo, options)
    ...
    getBlacklistDeviceList(
      ...
      filter?: string,
      options?: any,
    ): AxiosPromise<BlackDeviceList> {
      return localVarFp
        .getBlacklistDeviceList(offset, limit, filter, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    modifyBlackList(serialNumber: string, blackDeviceInfo?: BlackDeviceInfo, options?: any): AxiosPromise<object> {
      return localVarFp
        .modifyBlackList(serialNumber, blackDeviceInfo, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class BlacklistApi extends BaseAPI {
  ...
  public createBlackListDevice(serialNumber: string, blackDeviceInfo?: BlackDeviceInfo, options?: any) {
    return BlacklistApiFp(this.configuration)
      .createBlackListDevice(serialNumber, blackDeviceInfo, options)
  ...
  public deleteFromBlackList(serialNumber: string, options?: any) {
    return BlacklistApiFp(this.configuration)
      .deleteFromBlackList(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getBlacklistDevice(serialNumber: string, options?: any) {
    return BlacklistApiFp(this.configuration)
      .getBlacklistDevice(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
...
export const CommandsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteACommand: async (commandUUID: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/command/{commandUUID}`.replace(
        `{${'commandUUID'}}`,
        encodeURIComponent(String(commandUUID)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    deleteDeviceCapabilities: async (serialNumber: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/device/{serialNumber}/capabilities`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    deleteDeviceHealthChecks: async (
      serialNumber: string,
      startDate?: number,
      endDate?: number,
      options: any = {},
      ...
      const localVarPath = `/device/{serialNumber}/healthchecks`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteDeviceLogs: async (
      ...
      const localVarPath = `/device/{serialNumber}/logs`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteDeviceStats: async (
      ...
      const localVarPath = `/device/{serialNumber}/statistics`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    eventQueueRequest: async (
      ...
      const localVarPath = `/device/{serialNumber}/eventqueue`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    eventTelemetryStreamRequest: async (
      serialNumber: string,
      ...
      const localVarPath = `/device/{serialNumber}/telemetry`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    executeCommand: async (
      ...
      const localVarPath = `/device/{serialNumber}/command`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    factoryReset: async (
      ...
      const localVarPath = `/device/{serialNumber}/factory`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getDeviceStatus: async (serialNumber: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/device/{serialNumber}/status`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getRttySessionInfo: async (serialNumber: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/device/{serialNumber}/rtty`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    ledsRequest: async (serialNumber: string, lEDsRequest?: LEDsRequest, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/device/{serialNumber}/leds`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    messageRequest: async (
      ...
      const localVarPath = `/device/{serialNumber}/request`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    rebootDevice: async (
      ...
      const localVarPath = `/device/{serialNumber}/reboot`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    traceRequest: async (
      ...
      const localVarPath = `/device/{serialNumber}/trace`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateConfigurationForADevice: async (
      serialNumber: string,
      ...
      const localVarPath = `/device/{serialNumber}/configure`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    upgradeDeviceFirmware: async (
      ...
      const localVarPath = `/device/{serialNumber}/upgrade`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    wifiscanRequest: async (
      ...
      const localVarPath = `/device/{serialNumber}/wifiscan`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const CommandsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async deleteCommands(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteCommands(
        serialNumber,
        startDate,
        endDate,
        options,
     ...
     * @throws {RequiredError}
     */
    async deleteDeviceCapabilities(
      serialNumber: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Success>> {
     ...
     * @throws {RequiredError}
     */
    async deleteDeviceHealthChecks(
      serialNumber: string,
      startDate?: number,
      endDate?: number,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Success>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDeviceHealthChecks(
        serialNumber,
        startDate,
        endDate,
        options,
    ...
    async deleteDeviceLogs(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDeviceLogs(
        serialNumber,
        startDate,
        endDate,
        logType,
     ...
     * @throws {RequiredError}
     */
    async deleteDeviceStats(
      serialNumber: string,
      startDate?: number,
      endDate?: number,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Success>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDeviceStats(
        serialNumber,
        startDate,
        endDate,
        options,
     ...
     * @throws {RequiredError}
     */
    async eventQueueRequest(
      serialNumber: string,
      eventQueueRequest?: EventQueueRequest,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.eventQueueRequest(
        serialNumber,
        eventQueueRequest,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async eventTelemetryStreamRequest(
      serialNumber: string,
      telemetryStreamRequest?: TelemetryStreamRequest,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.eventTelemetryStreamRequest(
        serialNumber,
        telemetryStreamRequest,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async getACommandDetails(
      commandUUID: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommandInfo>> {
    ...
    async getCommandList(
      ...
      newest?: boolean,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommandInfoList>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCommandList(
        serialNumber,
        startDate,
        endDate,
        offset,
    ...
    async getDeviceCapabilities(
      serialNumber: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeviceCapabilities>> {
    ...
    async getDeviceHealthChecks(
      ...
      lastOnly?: boolean,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HealthCheckList>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDeviceHealthChecks(
        serialNumber,
        startDate,
        endDate,
        offset,
    ...
    async getDeviceLogs(
      ...
      newest?: boolean,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeviceLogList>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDeviceLogs(
        serialNumber,
        startDate,
        endDate,
        offset,
    ...
    async getDeviceStats(
      ...
      newest?: boolean,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StatisticsRecords | LifetimeStatistics>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDeviceStats(
        serialNumber,
        startDate,
        endDate,
        offset,
    ...
    async getDeviceStatus(
      serialNumber: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeviceStatus>> {
     ...
     * @throws {RequiredError}
     */
    async getRttySessionInfo(
      serialNumber: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RttySessionDetails>> {
     ...
     * @throws {RequiredError}
     */
    async updateConfigurationForADevice(
      serialNumber: string,
      deviceConfigureRequest?: DeviceConfigureRequest,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateConfigurationForADevice(
        serialNumber,
        deviceConfigureRequest,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async upgradeDeviceFirmware(
      serialNumber: string,
      upgradeRequest?: UpgradeRequest,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.upgradeDeviceFirmware(
        serialNumber,
        upgradeRequest,
        options,
      );
...
export const CommandsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    deleteCommands(serialNumber: string, startDate?: number, endDate?: number, options?: any): AxiosPromise<Success> {
      return localVarFp
        .deleteCommands(serialNumber, startDate, endDate, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    deleteDeviceHealthChecks(
      ...
      return localVarFp
        .deleteDeviceHealthChecks(serialNumber, startDate, endDate, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    deleteDeviceLogs(
      ...
      return localVarFp
        .deleteDeviceLogs(serialNumber, startDate, endDate, logType, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    deleteDeviceStats(
      ...
      return localVarFp
        .deleteDeviceStats(serialNumber, startDate, endDate, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    eventQueueRequest(serialNumber: string, eventQueueRequest?: EventQueueRequest, options?: any): AxiosPromise<void> {
      return localVarFp
        .eventQueueRequest(serialNumber, eventQueueRequest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    eventTelemetryStreamRequest(
      ...
      return localVarFp
        .eventTelemetryStreamRequest(serialNumber, telemetryStreamRequest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    getCommandList(
      ...
      newest?: boolean,
      options?: any,
    ): AxiosPromise<CommandInfoList> {
      return localVarFp
        .getCommandList(serialNumber, startDate, endDate, offset, limit, newest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    getDeviceHealthChecks(
      ...
      lastOnly?: boolean,
      options?: any,
    ): AxiosPromise<HealthCheckList> {
      return localVarFp
        .getDeviceHealthChecks(serialNumber, startDate, endDate, offset, limit, newest, lastOnly, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    getDeviceLogs(
      ...
      newest?: boolean,
      options?: any,
    ): AxiosPromise<DeviceLogList> {
      return localVarFp
        .getDeviceLogs(serialNumber, startDate, endDate, offset, limit, logType, newest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    getDeviceStats(
      ...
      newest?: boolean,
      options?: any,
    ): AxiosPromise<StatisticsRecords | LifetimeStatistics> {
      return localVarFp
        .getDeviceStats(serialNumber, startDate, endDate, offset, limit, lifetime, lastOnly, newest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    updateConfigurationForADevice(
      ...
      return localVarFp
        .updateConfigurationForADevice(serialNumber, deviceConfigureRequest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    upgradeDeviceFirmware(serialNumber: string, upgradeRequest?: UpgradeRequest, options?: any): AxiosPromise<void> {
      return localVarFp
        .upgradeDeviceFirmware(serialNumber, upgradeRequest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    wifiscanRequest(serialNumber: string, wifiScanRequest?: WifiScanRequest, options?: any): AxiosPromise<void> {
      return localVarFp
        .wifiscanRequest(serialNumber, wifiScanRequest, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class CommandsApi extends BaseAPI {
  ...
  public deleteACommand(commandUUID: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .deleteACommand(commandUUID, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public deleteDeviceCapabilities(serialNumber: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .deleteDeviceCapabilities(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
   ...
   * @memberof CommandsApi
   */
  public eventTelemetryStreamRequest(
    serialNumber: string,
    telemetryStreamRequest?: TelemetryStreamRequest,
    options?: any,
  ) {
  ...
  public executeCommand(serialNumber: string, commandDetails?: CommandDetails, options?: any) {
    return CommandsApiFp(this.configuration)
      .executeCommand(serialNumber, commandDetails, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public factoryReset(serialNumber: string, factoryRequest?: FactoryRequest, options?: any) {
    return CommandsApiFp(this.configuration)
      .factoryReset(serialNumber, factoryRequest, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getACommandDetails(commandUUID: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .getACommandDetails(commandUUID, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getDeviceCapabilities(serialNumber: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .getDeviceCapabilities(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getDeviceStatus(serialNumber: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .getDeviceStatus(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getRttySessionInfo(serialNumber: string, options?: any) {
    return CommandsApiFp(this.configuration)
      .getRttySessionInfo(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public ledsRequest(serialNumber: string, lEDsRequest?: LEDsRequest, options?: any) {
    return CommandsApiFp(this.configuration)
      .ledsRequest(serialNumber, lEDsRequest, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public messageRequest(serialNumber: string, messageRequest?: MessageRequest, options?: any) {
    return CommandsApiFp(this.configuration)
      .messageRequest(serialNumber, messageRequest, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public rebootDevice(serialNumber: string, rebootRequest?: RebootRequest, options?: any) {
    return CommandsApiFp(this.configuration)
      .rebootDevice(serialNumber, rebootRequest, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public traceRequest(serialNumber: string, traceRequest?: TraceRequest, options?: any) {
    return CommandsApiFp(this.configuration)
      .traceRequest(serialNumber, traceRequest, options)
      .then(request => request(this.axios, this.basePath));
  }
   ...
   * @memberof CommandsApi
   */
  public updateConfigurationForADevice(
    serialNumber: string,
    deviceConfigureRequest?: DeviceConfigureRequest,
    options?: any,
  ) {
...
export const ConfigurationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    createDefaultConfiguration: async (
      ...
      const localVarPath = `/default_configuration/{name}`.replace(`{${'name'}}`, encodeURIComponent(String(name)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    updateDefaultConfiguration: async (
      name: string,
      defaultConfiguration?: DefaultConfiguration,
      options: any = {},
    ): Promise<RequestArgs> => {
...
export const ConfigurationsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createDefaultConfiguration(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.createDefaultConfiguration(
        name,
     ...
     * @throws {RequiredError}
     */
    async deleteDefaultConfiguration(
      name: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
    ...
    async getDefaultConfiguration(
      name: string,
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DefaultConfiguration>> {
    ...
    async getDefaultConfigurations(
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DefaultConfigurationList>> {
    ...
    async updateDefaultConfiguration(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateDefaultConfiguration(
        name,
        defaultConfiguration,
        options,
      );
...
export const ConfigurationsApiFactory = function (
  ...
  return {
    ...
    createDefaultConfiguration(
      ...
      return localVarFp
        .createDefaultConfiguration(name, defaultConfiguration, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Delete a default default configuration
    ...
    updateDefaultConfiguration(
      ...
      return localVarFp
        .updateDefaultConfiguration(name, defaultConfiguration, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class ConfigurationsApi extends BaseAPI {
  ...
  public deleteDefaultConfiguration(name: string, options?: any) {
    return ConfigurationsApiFp(this.configuration)
      .deleteDefaultConfiguration(name, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getDefaultConfiguration(name: string, options?: any) {
    return ConfigurationsApiFp(this.configuration)
      .getDefaultConfiguration(name, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getDefaultConfigurations(options?: any) {
    return ConfigurationsApiFp(this.configuration)
      .getDefaultConfigurations(options)
      .then(request => request(this.axios, this.basePath));
  }
...
export const DevicesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    createNewDevice: async (
      ...
      const localVarPath = `/device/{serialNumber}`.replace(
        `{${'serialNumber'}}`,
        encodeURIComponent(String(serialNumber)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DevicesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createNewDevice(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.createNewDevice(
        serialNumber,
        validateOnly,
        device,
        options,
    ...
    async getCapabilitiesList(
      options?: any,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CapabilitiesModelList>> {
    ...
    async getDeviceList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DeviceList | DeviceListWithStatus | SerialNumberList | DeviceCount>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDeviceList(
        offset,
        limit,
        filter,
        select,
...
export const DevicesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createNewDevice(
      ...
      return localVarFp
        .createNewDevice(serialNumber, validateOnly, device, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    getDeviceList(
      ...
      return localVarFp
        .getDeviceList(offset, limit, filter, select, serialOnly, countOnly, deviceWithStatus, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
...
export class DevicesApi extends BaseAPI {
  ...
  public deleteDevice(serialNumber: string, options?: any) {
    return DevicesApiFp(this.configuration)
      .deleteDevice(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getDeviceInformation(serialNumber: string, options?: any) {
    return DevicesApiFp(this.configuration)
      .getDeviceInformation(serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public updateNewDevice(serialNumber: string, device?: Device, options?: any) {
    return DevicesApiFp(this.configuration)
      .updateNewDevice(serialNumber, device, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export const FilesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteUploadFidelete: async (uuid: string, serialNumber: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/file/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export class FilesApi extends BaseAPI {
  ...
  public deleteUploadFidelete(uuid: string, serialNumber: string, options?: any) {
    return FilesApiFp(this.configuration)
      .deleteUploadFidelete(uuid, serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getUploadFile(uuid: string, serialNumber: string, options?: any) {
    return FilesApiFp(this.configuration)
      .getUploadFile(uuid, serialNumber, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export class OUIsApi extends BaseAPI {
  ...
  public getOUIs(macList: string, options?: any) {
    return OUIsApiFp(this.configuration)
      .getOUIs(macList, options)
      .then(request => request(this.axios, this.basePath));
  }
}
